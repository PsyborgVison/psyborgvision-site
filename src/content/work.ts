...
export const projects: WorkProject[] = [
  ...
  },
  {
    ...
    channels: [
      ...
      { label: "Bing Places" },
      { label: "Apple Maps" },
      { label: "X", url: "https://x.com/sunnysideebikes" },
      { label: "Snapchat" },
      { label: "Pinterest", status: "planned", note: "Setting up now" },
    ...
    caseStudy: [
      ...
      },
      {
        ...
        body: "Beyond the site, I run Sunnyside's day-to-day presence: Instagram, TikTok, YouTube, X and Snapchat for content, and Google, Bing Places, Apple Maps and Yelp for the listings people actually tap to find the shop. Sunnyside doesn't have its own Facebook login, so the Page runs through my PsyborgVision Meta Business Suite. The first job was the same one I did for B&M: fold the look-alike handles and near-duplicate pages into one identity, so reviews and followers stop splitting. Pinterest and Nextdoor are being set up now, with Reddit to follow this winter.",
      },
    ],
  },
  {
